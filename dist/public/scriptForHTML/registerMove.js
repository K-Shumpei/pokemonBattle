...
for (let i = 0; i < 4; i++) {
    ...
    document.write('<td =align="center"><input type="button" value="▲" onclick="addPowerPoint(' + i + ')"></td>');
    document.write('<td =align="center"><input type="button" value="▼" onclick="subPowerPoint(' + i + ')"></td>');
    document.write('</tr>');
}
