...
// 途中交代コマンド送信
function sendExtraCommand(): void {
...
// コマンド返還
socket.on( 'returnExtraCommand', ( myCommand: ExtraCommand, opponentCommand: ExtraCommand, random: number[] ) => {
